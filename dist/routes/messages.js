...
router.get('/', (0, express_validator_1.query)('cursor').isNumeric().optional(), (0, express_validator_1.query)('limit').isNumeric().optional(), (0, express_validator_1.query)('direction').isString().optional(), request_validator_1.default, session_validator_1.default, controller.list);
router.get('/stats', request_validator_1.default, session_validator_1.default, controller.stats);
router.get('/stats/7d', request_validator_1.default, session_validator_1.default, controller.stats7d);
router.get('/table', (0, express_validator_1.query)('cursor').isNumeric().optional(), (0, express_validator_1.query)('limit').isNumeric().optional(), (0, express_validator_1.query)('direction').isString().optional(), (0, express_validator_1.query)('jid').isString().optional(), (0, express_validator_1.query)('q').isString().optional(), request_validator_1.default, session_validator_1.default, controller.listTable);
