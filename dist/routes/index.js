...
const quickreplies_1 = __importDefault(require("./quickreplies"));
...
router.use('/:sessionId/ai', ai_1.default);
router.use('/agents', agents_1.default);
router.use('/:sessionId/tickets', tickets_1.default);
// API prefix to avoid collision with static dashboard folder
router.use('/api/quick-replies', quickreplies_1.default);
